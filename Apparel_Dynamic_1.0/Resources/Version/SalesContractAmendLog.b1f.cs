...
{
    [FormAttribute("Apparel_Dynamic_1._0.Resources.Version.SalesContractAmendLog", "Resources/Version/SalesContractAmendLog.b1f")]
    class SalesContractAmendLog : UserFormBase
    {
        public SalesContractAmendLog()
        {
        }
        ...
        private SAPbouiCOM.EditText ETCUSTMR, ETCUSTNM, ETBRNDCD, ETBRNDNM, ETSCNO,
                                    ...
                                    ETBRANCH, ETMRSTAT, ETCMSTAT, ETDSNBNK, ETSERIES, 
                                    ETINTRMS, ETPYTRMS, ETMDSHIP, ETSHPADD, ETPRTSHP;

        // -------- Folder --------
        private SAPbouiCOM.Folder FOLORDTL, FOLB2BDL, FOLATTCH, FOLCDTLS;
        ...
        public override void OnInitializeComponent()
        {
            ...
            //               -------- Grid --------
            this.ETBRANCH = ((SAPbouiCOM.EditText)(this.GetItem("ETBRANCH").Specific));
            this.ETMRSTAT = ((SAPbouiCOM.EditText)(this.GetItem("ETMRSTAT").Specific));
            this.ETCMSTAT = ((SAPbouiCOM.EditText)(this.GetItem("ETCMSTAT").Specific));
            ...
            this.ETMDSHIP = ((SAPbouiCOM.EditText)(this.GetItem("ETMDSHIP").Specific));
